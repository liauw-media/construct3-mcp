...
- **`test/fixtures/c3-loadable-minimal/`** — 11 files, ~18 KB packed. IP-free. **Validated 2026-04-16** by loading into Construct 3 editor via ClawForge automation — opens cleanly, no "Failed to open project" dialog.
